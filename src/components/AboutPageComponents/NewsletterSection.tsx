    ...
    <div className="py-10 px-6 md:py-16 md:px-12 flex items-center justify-center">
      <Card className="max-w-[1273px] w-full text-center px-8 md:px-14 py-8 md:py-12 rounded-lg shadow-sm">
        ...
        <CardContent>
          ...
          Sign Up for our updates and enjoy exclusive access to discounts, coupons, vouchers, the latest collections, design tips, and special events tailored just for <span className="text-orange-500 font-semibold">you.</span>
          </p>

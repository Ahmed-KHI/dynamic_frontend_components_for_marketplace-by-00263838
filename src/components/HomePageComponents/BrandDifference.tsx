      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-[1440px] w-full">
        ...
        <Card className="bg-card shadow-md">
          <CardHeader className="flex flex-col items-center text-center">
            <Image src="/fast-truck.png" alt="logo" width={40} height={40} />
        ...
        <Card className="bg-card shadow-md">
          <CardHeader className="flex flex-col items-center text-center">
          <Image src="/handmade.png" alt="logo" width={40} height={40} />
            <CardTitle className="text-lg font-semibold text-foreground">
        ...
        <Card className="bg-card shadow-md">
          <CardHeader className="flex flex-col items-center text-center">
          <Image src="/tag.png" alt="logo" width={40} height={40} />
            <CardTitle className="text-lg font-semibold text-foreground">
              Unbeatable prices
            </CardTitle>
          </CardHeader>
        ...
        <Card className="bg-card shadow-md">
          <CardHeader className="flex flex-col items-center text-center">
          <Image src="/recycle.png" alt="logo" width={40} height={40} />
            <CardTitle className="text-lg font-semibold text-foreground">
              Recycled packaging
            </CardTitle>
          </CardHeader>

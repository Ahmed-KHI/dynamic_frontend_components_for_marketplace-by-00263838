  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:title" content="Blog - E-commerce Insights" />
        <meta
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {posts.length === 0 ? (
            <p className="text-gray-600 text-center">No posts available right now.</p>
          ) : (
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {posts.map((post) => (
                ...
                >
                  ...
                  />
                  <div className="p-6">
                    <time className="block text-sm text-gray-500 mb-2">{post.date}</time>
                    ...
                    <Link href={`/blog/${post.id}`} className="text-orange-500 hover:underline">
                      Read More
                    </Link>
                  </div>
                </article>

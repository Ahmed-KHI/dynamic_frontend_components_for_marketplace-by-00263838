...
export const posts: Post[] = [
  {
    ...
    content: `
      ...
      1 - Hyphen Bed Rs. 99,000/- (Get Rs. 3,000/- Gift Voucher)
      2 - Patric Bundle Rs. 259,000/- (Get Rs. 20,000/- Gift Voucher)
      3 - Sebastian Bundle Rs. 379,000/- (Get Rs. 40,000/- Gift Voucher)
      4 - Opulent Bundle Rs. 699,000/- (Get Rs. 75,000/- Gift Voucher)
  ...
  },
  {
    ...
    date: 'January 2, 2025',
    content: `
      This year, furniture trends emphasize sustainability, minimalist aesthetics, and organic materials. Rattan chairs and reclaimed wood tables dominate interiors, while earthy tones and neutral palettes set a calming atmosphere. Modular designs and smart furniture also shine, blending modern technology with timeless style. Stay ahead with these top trends!
    `,
  },
  {
    id: 5,
